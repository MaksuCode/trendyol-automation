...
import tr.com.trendyol.pages.categorypages.*;
...
//    }
     ...
     * The reason why I did like this is I wanted to keep following POM(Page Object Model) which enables us to hold the tr.com.trendyol.pages as Objects.
     *
     * @return : Category tr.com.trendyol.pages (individually)
     */

    public WomanCategoryPage clickWomanCategory() {
        WebElement element = driver.findElements(category).get(0);
        String text = element.getText() ;
        element.click();
        Reporter.log("* Clicked " + text.toLowerCase() + " category.\n");
